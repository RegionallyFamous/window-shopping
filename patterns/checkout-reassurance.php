 ...
 */
?>
<!-- wp:group {"align":"wide","className":"ws-checkout-reassurance ws-surface","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}},"border":{"color":"var:preset|color|muted","width":"1px","radius":"var(--wp--custom--window--checkout-radius)"},"shadow":"var:preset|shadow|crisp"},"layout":{"type":"grid","minimumColumnWidth":"var(--wp--custom--window--reassurance-item-min)"},"backgroundColor":"surface"} -->
<div class="wp-block-group alignwide ws-checkout-reassurance ws-surface has-surface-background-color has-background" style="border-color:var(--wp--preset--color--muted);border-width:1px;border-radius:var(--wp--custom--window--checkout-radius);box-shadow:var(--wp--preset--shadow--crisp);padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
